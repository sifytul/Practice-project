...
const valuesInObject = require('../problems/02-values-in-object')

describe("valuesInObject()", ()=>{
    it("should return an array containing all object values", () => {
        const food = valuesInObject({
            mango: "sweet", 
            dragonFruit: "salty",
            tamarind: "sour"
        })
        const foodResult = ["sweet", "salty", "sour"]
        assert.deepEqual(food, foodResult)
    })
})